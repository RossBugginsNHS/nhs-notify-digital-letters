...
<table>
<tbody>
<tr><th>$id</th><td>/digital-letters/2025-10-draft/digital-letters-viewer-services.schema.json</td></tr>
...
<table class="jssd-property-table">
  <tbody>
    ...
    <tr>
      <th>Pattern</th>
      <td colspan="2">^uk\.nhs\.notify\.digital\.letters\.viewer\.[a-z0-9]+(?:\.[a-z0-9]+)*\.v[0-9]+$</td>
    </tr>
  </tbody>
</table>
...
<table class="jssd-property-table">
  <tbody>
    ...
    <tr>
      ...
      <th>Pattern</th>
      <td colspan="2">^/nhs/england/notify/(production|staging|development|uat)/(primary|secondary|dev-[0-9]+)/(data-plane|control-plane)/digitalletters/viewer</td>
    </tr>
  </tbody>
</table>
            ...
            "allOf": [
                {
                    ...
                    "type": "string",
                    "pattern": "^uk\\.nhs\\.notify\\.digital\\.letters\\.viewer\\.[a-z0-9]+(?:\\.[a-z0-9]+)*\\.v[0-9]+$"
                }
            ]
        },
        "source": {
            "type": "string",
            "pattern": "^/nhs/england/notify/(production|staging|development|uat)/(primary|secondary|dev-[0-9]+)/(data-plane|control-plane)/digitalletters/viewer",
            "minLength": 40,
